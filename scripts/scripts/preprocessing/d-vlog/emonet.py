...
class EmoNet(nn.Module):
    ...
    def forward(self, x, reset_smoothing=False):
        ...
        final_features_embed = final_features.view(batch_size, final_features.shape[1])
        final_features = self.emo_fc_2(final_features_embed)
        ...
        return final_features_embed, {'heatmap': tmp_out, 'expression': final_features[:,:-2], 'valence': final_features[:,-2], 'arousal':final_features[:,-1]}
