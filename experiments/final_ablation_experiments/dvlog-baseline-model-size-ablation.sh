...
for PRESENCE_THRESHOLD in 0.5 0.25 0.75
do
  for SECONDS_PER_WINDOW in 6 1 3 9
  do
    for RUN_ID in 1 2 3
    do
    ...
    WANDB_NAME="pt-$PRESENCE_THRESHOLD-spw-SECONDS_PER_WINDOW-nl-8-nh4-hd64-run-$RUN_ID"
    python main.py --run_id $RUN_ID --name $WANDB_NAME $TRAINING_ARGS $DEFAULT_ARGS --model_args.num_layers 8 --model_args.self_attn_num_heads 4 --model_args.self_attn_dim_head 64
